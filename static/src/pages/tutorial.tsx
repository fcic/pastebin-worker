          ...
          <div className="p-8">
            <header className="mb-12 text-center">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                Learn how to use fcicShare for sharing code snippets, text, and
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 mb-6">
                <p className="text-gray-700 dark:text-gray-200 text-lg leading-relaxed">
                  fcicShare is a free, fast, and secure pastebin service built
            ...
            <section className="mb-12">
              ...
              <div className="bg-white dark:bg-gray-750 rounded-xl border border-gray-200 dark:border-gray-600 p-6">
                <p className="text-gray-600 dark:text-gray-300 mb-6">
                  fcicShare supports syntax highlighting for a wide variety of
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">
                      Contribute to fcicShare
                    </h3>
                    <p className="text-gray-700 dark:text-gray-200 mb-4 leading-relaxed">
                      fcicShare is open source and available on GitHub. We
                      welcome contributions, bug reports, feature requests, and
                      feedback from the community. Help us make fcicShare even
                      better!
                    </p>
